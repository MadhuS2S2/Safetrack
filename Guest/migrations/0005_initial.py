...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('Guest', '0004_remove_tbl_ashaworker_worker_ward_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('worker_ward', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='Admin.tbl_ward')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kitchen_ward', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='Admin.tbl_ward')),
            ],
        ),
        migrations.CreateModel(
            name='tbl_user',
            fields=[
                ...
                ('user_ward', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='Admin.tbl_ward')),
            ],
        ),
        migrations.CreateModel(
            name='tbl_wardmember',
            fields=[
                ...
                ('member_ward', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='Admin.tbl_ward')),
            ],
        ),
    ]
